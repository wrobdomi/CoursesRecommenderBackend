...
//    @Query("SELECT NEW com.example.demo.shared.dto.CourseRatingStatistics(u.course_id, sum(u.rating)) FROM user_course_ratings u GROUP BY u.course_id")
//    List<CourseRatingStatistics> getSumForEachCourse();
}
